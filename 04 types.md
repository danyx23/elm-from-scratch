...
As an aside - no, you can't define such typeclasses like `number` on your own, only the language itself can define them (there are two more, `comparable` and `appendable`).
